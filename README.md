...
1. **Initial Machine Setup**
    ...
    Running this first time? Then complete the [Initial Machine Setup](#initial-machine-setup).

2. **Clone the project**

    `git clone https://github.com/gsn16/react-redux-router-babel-webpack-jest-sass-browsesrsync.git`.
...
7. Make sure you don't have NODE_ENV set to production on your machine. If you do then the development dependencies won't be installed. Here's [how to check](http://stackoverflow.com/a/27939821/26180).
